  ...
  std::string                   selectorType)
{
  ...
  if (matcherType.compare("MAT_BF") == 0)
  {
    ...
    // With other binary descriptors
      ...
      throw std::invalid_argument(descriptorType + " NOT VALID");
    }
  ...
  // FLANN matching
    ...
    // With other binary descriptorTypes
    else if (descriptorType.compare("DES_BINARY") == 0) {
    ...
    throw std::invalid_argument(matcherType + " NOT VALID matcherType");
  }
  ...
  // Perform k nearest neighbors (k=2)
    ...
    throw std::invalid_argument(selectorType + " NOT VALID selectorType");
  }
}
  ...
  std::string                descriptorType)
{
  ...
  if (descriptorType.compare("BRISK") == 0) {
    ...
    throw std::invalid_argument(descriptorType + " NOT VALID descriptorType");
  }
  ...
  bool                       bVis)
{
  ...
  // Maximum overlap between two features in %
...
// Detect keypoints in an image using more modern methods from OpenCV
  ...
  bool                       bVis)
{
  if (detectorType.compare("FAST") == 0) {
    ...
    throw std::invalid_argument(detectorType + " NOT VALID detectorType");
  }
